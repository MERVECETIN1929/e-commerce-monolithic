...
public class UserManager implements UserService{
    ...
    @Override
    public CreateAdminResponse addAdmin(CreateAdminRequest request) {
        ...
        String token=tokenService.generateToken(user);
        var saveUser = repository.save(user);
        CreateAdminResponse createAdminResponse=mapper.forResponse().map(saveUser, CreateAdminResponse.class);
        createAdminResponse.setToken(token);
